...
from ai4stocks.common import META_COLS, INT_MAX_VALUE, INT_MIN_VALUE, FLOAT_MAX_VALUE, FLOAT_MIN_VALUE, \
    FuquanType, DataSourceType, DataFreqType, StockCode
...
class BsStockMinuteHandler(SlowHandlerBase):
    ...
    def __save_to_database__(
        ...
        self.operator.create_table(name, table_meta)
