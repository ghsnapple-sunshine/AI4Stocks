...
if __name__ == '__main__':
    ...
    StockDailyHandler(op=op).DownloadAndSave(start_time=start_date, end_time=end_date)
    StockMinuteHandler(op=op).DownloadAndSave(start_time=start_date, end_time=end_date)
