 ...
 *         # d[t+n]
 */
  __pyx_t_7 = (__pyx_v_num - __pyx_v_period);
  __pyx_t_8 = __pyx_t_7;
 ...
 *         # print(f"--round:{i}--")
 */
    __pyx_t_10 = (__pyx_v_i + __pyx_v_period);
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_pybuffernd_res.diminfo[0].shape;
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_pybuffernd_res.diminfo[0].shape)) __pyx_t_12 = 0;
    if (__pyx_t_11 < 0) {
 ...
 */
    ...
    if (__pyx_t_11 < 0) {
      ...
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_res.diminfo[0].shape)) __pyx_t_12 = 0;
    if (__pyx_t_10 < 0) {
 ...
 */
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_res.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_7 < 0)) {
      PyErr_Fetch(&__pyx_t_14, &__pyx_t_15, &__pyx_t_16);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_res.rcbuffer->pybuffer, (PyObject*)__pyx_v_res, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
