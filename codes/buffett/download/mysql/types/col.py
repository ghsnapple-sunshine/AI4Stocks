...
class ColType(Enum):
    ...
    def create(cls, col_type: str) -> ColType:
        COL_TYPE_DICT = {'VARCHAR(8)': 1,  # ColType.STOCK_CODE_NAME,
                         'VARCHAR(10)': 2,  # ColType.LONG_STOCK_CODE,
    ...
    CONCEPT_CODE_NAME = 2  # 概念代码（10位）/概念名字
    FLOAT = 4
    INT32 = 5
    DATE = 10  # 日期
    DATETIME = 11  # 日期时间
    ...
    def sql_format(self):
        COL_TYPE_DICT = {ColType.STOCK_CODE_NAME: 'VARCHAR(8)',
                         ColType.CONCEPT_CODE_NAME: 'VARCHAR(10)',
                         ColType.FLOAT: 'FLOAT',
                         ColType.INT32: 'INT',
                         ColType.DATE: 'DATE',
