...
from test.suites.tools import create_1index, create_2indexs, create_ex_1index
from test.suites.tools import create_1industry, create_2industries, create_ex_1industry
from test.suites.tools import create_1stock, create_2stocks, create_ex_1stock
